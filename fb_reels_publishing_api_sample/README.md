...
* For your reference the Reels Publishing API documentation is located [here](https://developers.facebook.com/docs/video-api/guides/reels-publishing) and the Stories Publishing API document is located [here](https://developers.facebook.com/docs/page-stories-api/)
